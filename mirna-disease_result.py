...
#                   index_col=None)
M_M = pd.read_csv(r"C:\Users\acer\Desktop\model\VGAMF-main\code_and_data\VGAMF_m_m.csv", header=None,
                  index_col=None)
...
#                   index_col=None)
D_D = pd.read_csv(r"C:\Users\acer\Desktop\model\VGAMF-main\code_and_data\VGAMF_d_d.csv", header=None,
                  index_col=None)
...
M_D = pd.read_csv(r"C:\Users\acer\Desktop\model\VGAMF-main\code_and_data\VGAMF_m_d.csv", header=None,
                  index_col=None, dtype=int)
...
for train_index, test_index in kf.split(X_sample):
    ...
    if ite < 6:
        ...
        df = pd.DataFrame(columns=['mirna_name', 'disease_name'])
